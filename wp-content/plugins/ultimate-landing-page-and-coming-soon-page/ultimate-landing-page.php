...
/*  Copyright 2012, 2013, 2014 Jeff Bullins (email : support@thinklandingpages.com)
	...
	<div id="poststuff" class="metabox-holder has-right-sidebar">
		<div id="side-info-column" class="inner-sidebar">
			<div id="side-sortables" class="meta-box-sortables ui-sortable">
				<a target="_blank" href="http://www.thinklandingpages.com/landingpage/ultimate-landing-page-advanced-pricing-with-pro-version-2/?utm_source=inside%20landing%20page%20plugin%20banner-to-feature-page&utm_medium=plugin&utm_campaign=inside%20landing%20page%20plugin%20banner-to-feature-page">
			...
			<!-- End Background Image -->
				...
				<tr>
					...
					<td>
						<?php
							...
							wp_editor( $options['description'], "ulp_options_description", $args );
						?>
				...
				<tr>
					...
					<td>
						...
						<span style="color:#666666;margin-left:2px;"><a href="http://www.thinklandingpages.com/landingpage/ultimate-landing-page-advanced-pricing-with-pro-version-2/?utm_source=inside%20landing%20page%20plugin%20inline-to-feature-page&utm_medium=plugin&utm_campaign=inside%20landing%20page%20plugin%20inline-to-feature-page">Upgrade to the Advanced version</a></span>
					</td>
				</tr>
...
function getFonts(){
$fonts = array('ABeeZee','Aclonica','Alef','Alegreya Sans','Allan','Allerta','Allerta Stencil','Amaranth','Annie Use Your Telescope','Anonymous Pro','Anton','Architects Daughter','Arimo','Artifika','Arvo','Asset','Astloch','Audiowide','Bangers','Bentham','Bevan','Bigelow Rules','Bigshot One','Bowlby One SC','Brawler','Buda','Cabin','Cabin Sketch','Calligraffitti','Candal','Cantarell','Cardo','Carter One','Caudex','Cedarville Cursive','Ceviche One','Cherry Cream Soda','Chewy','Coda','Coming Soon','Copse','Corben','Cousine','Covered By Your Grace','Crafty Girls','Crimson Text','Crushed','Cuprum','Damion','Dancing Script','Dawning of a New Day','Didact Gothic','Diplomata SC','Droid Sans','Droid Sans Mono','Droid Serif','EB Garamond','Expletus Sans','Fontdiner Swanky','Forum','Francois One','Gafata','Gabriela','Geo','Goblin One','Goudy Bookletter','Gravitas One','Gruppo','Hammersmith One','Hind','Holtwood One SC','Homemade Apple','IM Fell','Inconsolata','Indie Flower','Irish Grover','Josefin Sans','Josefin Slab','Judson','Jura','Just Another Hand','Just Me Again Down Here','Kameron','Kenia','Kite One','Kotta One','Kranky','Kreon','Kristi','La Belle Aurore','Lato','League Script','Lekton', 'Libre Baskerville','Limelight','Lobster','Lobster Two','Lora','Love Ya Like A Sister','Loved by the King','Luckiest Guy','Maiden Orange','Mako','Margarine','Maven Pro','Meddon','MedievalSharp','Megrim','Merriweather','Metrophobic','Michroma','Miltonian','Molengo','Monofett','Monoton','Montez','Mountains of Christmas','Muli','Neucha','Neuton','News Cycle','Nobile','Nova','Nunito','OFL Sorts Mill Goudy TT','Old Standard TT','Open Sans','Orbitron','Oswald','Over the Rainbow','PT Sans','PT Serif','Pacifico','Patrick Hand','Paytone One','Permanent Marker','Philosopher','Play','Playfair Display','Podkova','Prosto One','Puritan','Quattrocento','Quattrocento Sans','Radley','Rajdhani','Raleway','Redressed','Reenie Beanie','Revalia','Roboto','Rock Salt','Rokkitt','Ruslan Display','Schoolbell','Shadows Into Light','Shanti','Sigmar One','Sintony','Sniglet','Six Caps','Slackey','Smythe','Sniglet','Sofadi One','Special Elite','Stardos Stencil','Sue Ellen Francisco','Sunshiney','Swanky and Moo Moo','Syncopate','Tangerine','Tauri','Tenor Sans','Terminal Dosis Light','The Girl Next Door','Tinos','Ubuntu','Ultra','UnifrakturCook','UnifrakturMaguntia','Unkempt','VT','Varela','Vibur','Vollkorn','Waiting for the Sunrise','Wallpoet','Walter Turncoat','Wellfleet','Wire One','Yanone Kaffeesatz','Zeyada');
return $fonts;
}
